...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <a href="<?= Url::l('setup/template/create'); ?>" class="btn btn-primary pull-right">Create Template</a>
        ...
        <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
                <thead>
                    <tr>
                        <th>#</th>
                        <th><?= $model_common->getAttributeLabel('template_code') ?></th>
                        <th><?= $model_common->getAttributeLabel('template_description') ?></th>
                        <th>Action</th>
                    </tr>
                </thead>
                <tbody>
                    <? foreach($lists as $key => $template): ?>
                        <tr>
                            <td><?= $key+1 ?></td>
                            <td><?= $template->template_code ?></td>
                            <td><?= $template->template_description ?></td>
                            <td>
                                <a href="<?= Url::l('setup/template/update/template_code/'.$template->template_code) ?>" class="tooltips action-update" data-toggle="tooltip" title="Update"><i class="fa fa-pencil"></i></a>&nbsp;
                                <a href="<?= Url::l('setup/template/resetpassword/template_code/'.$template->template_code) ?>" class="tooltips action-reset-password" data-toggle="tooltip" title="Reset Password"><i class="fa fa-key"></i></a>&nbsp;
                                <a href="<?= Url::l('setup/template/delete/template_code/'.$template->template_code) ?>" class="tooltips action-delete" data-toggle="tooltip" title="Delete"><i class="fa fa-trash-o"></i></a>&nbsp;
                            </td>
                        </tr>
                    <? endforeach ?>              
                </tbody>
            ...
            <div class="modal-content">
                <div class="box box-info">
                    <div class="box-header with-border">
                      <h3 class="box-title"><?= $model->isNewRecord ? 'Create ' : 'Update ' ?>Template</h3>
                    </div>                    
